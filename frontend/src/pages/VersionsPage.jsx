...
const VersionsPage = () => {
  ...
  const [newVersion, setNewVersion] = useState(''); // State for new version number
  const [newVersionRequiredParams, setNewVersionRequiredParams] = useState([]); // State for new version required params
  const [newVersionOptionalParams, setNewVersionOptionalParams] = useState([]); // State for new version optional params
          ...
          <form onSubmit={handleSubmit}>
            ...
            {newVersionRequiredParams.map((param, index) => (
              <div key={index} className="param-input">
                ...
                {param.type === 'yaml' || param.type === 'json' ? (
                  <textarea
                    placeholder={`Enter ${param.type.toUpperCase()} here`}
                    value={param.value}
                    onChange={(e) => handleParamValueChange(e.target.value, index, 'requiredParams')}
                  />
                ) : (
                  <input
                    type="text"
                ...
                <div key={index} className="param-input">
                  ...
                  {param.type === 'yaml' || param.type === 'json' ? (
                    <textarea
                      placeholder={`Enter ${param.type.toUpperCase()} here`}
                      value={param.value}
                      onChange={(e) => handleParamValueChange(e.target.value, index, 'optionalParams')}
                    />
                  ) : (
                    <input
                      type="text"
